...
class ScoreSpeechToTextDataset(FairseqDataset):
    ...
    def __getitem__(
        ...
        for id,subword in enumerate(subwords):
...
class ScoreSpeechToTextDatasetCreator(object):
    # mandatory columns
    ...
    def _from_list(
        ...
        pre_tokenizer,
        bpe_tokenizer,
    ) -> ScoreSpeechToTextDataset:
        audio_paths, n_frames, src_texts, tgt_texts, ids, scores = [], [], [], [], [], []
        ...
        for s in samples:
            ...
            scores.extend(float(ss[cls.KEY_Score]) for ss in s)

            src_langs.extend([ss.get(cls.KEY_SRC_LANG, cls.DEFAULT_LANG) for ss in s])
            tgt_langs.extend([ss.get(cls.KEY_TGT_LANG, cls.DEFAULT_LANG) for ss in s])
        return ScoreSpeechToTextDataset(
            split_name,
            is_train_split,
            data_cfg,
            audio_paths,
